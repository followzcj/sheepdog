...
if __name__ == "__main__":
    # 数据集文件夹路径 - 请替换为你的实际路径
    dataset_folder = r"E:\1study\papers\Cyber Security\Fake News in Sheep’s Clothing——Robust Fake News Detection " \
                     r"Against LLM-Empowered Style Attacks\dataset\Legitimate1000\460_legitimate"
    ...
    save_results(extracted_data, r"E:\1study\papers\Cyber Security\Fake News in Sheep’s Clothing——Robust Fake News "
                                 r"Detection Against LLM-Empowered Style Attacks\dataset\Legitimate1000.json")
    # 打印统计信息
