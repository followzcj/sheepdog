...
def read_and_process_pkl(pkl_path, output_dir):
    ...
    styles = ['neutral', 'objective','sensational', 'emotionally triggering']
...
def generate_veracity_pkl(output_dir, mainstream_style, tabloid_style):
    ...
    pkl_path = '../data/news_articles/news_train.pkl'
    with open(pkl_path, 'rb') as f:
...
if __name__ == "__main__":
    ...
    generate_veracity_pkl(output_directory, 'objective', 'emotionally triggering')
