...
# file:process_data_phish_sample_30k_html.py
# author:ZCJ
# datetime:2025-10-20 18:22
# software: PyCharm
...
if __name__ == "__main__":
    # 数据集文件夹路径 - 请替换为你的实际路径
    dataset_folder = r"E:\1study\papers\Cyber_Security\sheepdog\dataset\phish_sample_30k"

    # 处理数据集，最多处理10个
    extracted_data = process_dataset(dataset_folder, max_items=1000)

    # 保存结果
    save_results(extracted_data, r"E:\1study\papers\Cyber_Security\sheepdog\dataset\phish_sample_30k_html_1000.json")
    # 打印统计信息
